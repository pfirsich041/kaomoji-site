...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "3f6ae834-a611-4e08-816b-e4e23c03955c",
...
const _lazy_MJHtgI = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_MJHtgI, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_MJHtgI, lazy: true, middleware: false, method: undefined }
];
