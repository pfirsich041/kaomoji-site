<template>
  ...
  <div class="container px-5 py-8 my-10 mx-auto flex lg:justify-between md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    ...
    <div class="flex-grow flex flex-wrap lg:justify-end md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div class="lg:w-1/3 md:w-1/2 w-full px-4">
        <h2 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">contents</h2>
      ...
      <div class="lg:w-1/3 md:w-1/2 w-full px-4">
        ...
        <nav class="list-none mb-10">
          <li>
            <NuxtLink to="/privacy" class="text-gray-600 hover:text-gray-800 text-sm">プライバシーポリシー</NuxtLink>
          </li>
        </nav>
      </div>
    </div>
